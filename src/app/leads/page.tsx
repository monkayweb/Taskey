  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Leads & quotes</h1>
          <p className="mt-0.5 text-[13px] text-muted">
            Quotes are chased automatically after {FOLLOW_UP_DAYS} days of silence;
            inquiries are flagged after {INQUIRY_IDLE_HOURS} hours without a reply.
          </p>
        </div>
        <NewInquiry />
      </div>
    ...
    >
      ...
      <div>
        ...
        <input
          ...
          className="field h-9 w-[110px] py-0 font-mono text-[13px]"
        />
      </div>
