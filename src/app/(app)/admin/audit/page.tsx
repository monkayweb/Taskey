...
const TYPE_TONE: Record<AuditType, Tone> = {
  ...
  "client.acknowledged": "ok",
  "milestone.completed": "ok",
  "payment.received": "ok",
  "docs.requested": "accent",
  "docs.reminded": "warn",
  "docs.received": "ok",
  "qc.requested": "warn",
  "qc.approved": "ok",
  "qc.returned": "warn",
  "balance.invoiced": "accent",
  "project.submitted": "accent",
  "authority.query": "danger",
  "authority.followup": "neutral",
  "project.outcome": "ok",
  "project.deleted": "danger",
  "phase.advanced": "accent",
  "recurring.added": "accent",
  "recurring.paused": "neutral",
...
export default function AuditPage() {
  ...
  function exportCsv() {
    const rows = [
      ...
      ...filtered.map((e) => [
        e.at,
        users.find((u) => u.id === e.actorId)?.name ??
          (e.actorId === "system" ? "Taskey" : "A deleted person"),
        AUDIT_LABEL[e.type],
        e.subject,
        e.detail,
      ]),
                  ...
                  {filtered.slice(0, limit).map((e) => {
                    ...
                    return (
                      <tr key={e.id} className="hover:bg-sunken">
                        <td className="whitespace-nowrap px-5 py-2 text-[12px] tabular-nums text-muted">
                        ...
                        <td className="whitespace-nowrap px-3 py-2">
                          <Badge tone={TYPE_TONE[e.type]}>{AUDIT_LABEL[e.type]}</Badge>
                        </td>
